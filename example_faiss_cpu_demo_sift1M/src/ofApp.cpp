...
void ofApp::setup()
{
    ...
    
    {
        ...
        size_t nt;
        float *xt = fvecs_read(ofToDataPath("sift1M/sift_learn.fvecs", true).data(), &d, &nt);
    ...
    
    {
        ...
        size_t nb, d2;
        float *xb = fvecs_read(ofToDataPath("sift1M/sift_base.fvecs", true).data(), &d2, &nb);
    ...
    
    {
        ...
        size_t d2;
        xq = fvecs_read(ofToDataPath("sift1M/sift_query.fvecs", true).data(), &d2, &nq);
    ...
    
    {
        ...
        size_t nq2;
        int *gt_int = ivecs_read(ofToDataPath("sift1M/sift_groundtruth.ivecs", true).data(), &k, &nq2);
